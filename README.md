...
```hcl
module "arbium_aws" {
  source = "github.com/try-caret/arbium-terraform//aws/customer?ref=v0.2.3"
...
```hcl
module "arbium_gcp" {
  source = "github.com/try-caret/arbium-terraform//gcp/customer?ref=v0.2.3"
...
repository. Customers should pin `?ref=v0.2.3` or another explicit
