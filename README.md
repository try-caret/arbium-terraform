...
```hcl
module "arbium_aws" {
  source = "github.com/try-caret/arbium-terraform//aws/customer?ref=chaindb-v0.3.51"
...
```hcl
module "arbium_gcp" {
  source = "github.com/try-caret/arbium-terraform//gcp/customer?ref=chaindb-v0.3.51"
...
```hcl
module "arbium_azure" {
  source = "github.com/try-caret/arbium-terraform//azure/customer?ref=chaindb-v0.3.51"
...
repository. Customers should pin `?ref=chaindb-v0.3.51` or another explicit
