...
```hcl
module "arbium_aws" {
  source = "github.com/try-caret/arbium-terraform//aws/customer?ref=chaindb-v0.5.14"
...
```hcl
module "arbium_gcp" {
  source = "github.com/try-caret/arbium-terraform//gcp/customer?ref=chaindb-v0.5.14"
...
```hcl
module "arbium_azure" {
  source = "github.com/try-caret/arbium-terraform//azure/customer?ref=chaindb-v0.5.14"
...
repository. Customers should pin `?ref=chaindb-v0.5.14` or another explicit
